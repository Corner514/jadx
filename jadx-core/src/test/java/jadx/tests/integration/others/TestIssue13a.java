...
public class TestIssue13a extends IntegrationTest {
	...
	public static class TestCls {
		...
		private static final HashMap<ClassLoader, HashMap<String, Parcelable.Creator<?>>> M_CREATORS = new HashMap<>();
		...
		public final <T extends Parcelable> T test(ClassLoader loader) {
			...
			synchronized (M_CREATORS) {
				HashMap<String, Parcelable.Creator<?>> map = M_CREATORS.get(loader);
				if (map == null) {
					map = new HashMap<>();
